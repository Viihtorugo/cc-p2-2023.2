...
public class SystemController {
    ...
    public void zerarSistema() throws Exception {
        StateSystem.pushUndo(this.empregadoController);
    ...
    public void undo() throws Exception {
        this.empregadoController.setEmpregados(StateSystem.popUndo());
    }

    public void redo() throws Exception {
        this.empregadoController.setEmpregados(StateSystem.popRedo());
    }
